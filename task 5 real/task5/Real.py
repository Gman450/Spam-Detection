...
#NOTE: THE REAL IMPLEMENTATION TEST (ALPHA VERSION)--------------------------------------------

G=[1,143,71] #here i am putting a value for G which acts as the features for the input [first_param_always_1 , total_word_count, spam_word_count]
print "The new input is ", G 
print "The theta parameters are ", theta_min #this is the value of parameters that has produced the least error/cost
predi=pred(theta_min,G) #here i am calling the prediction function 'pred' which allows me to obtain the hypothesis h(x) value which involves subjecting it to the sigmoid function  
print "The obtained hypothesis value is ",predi #predi would return either 0 or 1. 0 means not spam, 1 means spam.

#END REAL IMPLEMENTATION TEST
