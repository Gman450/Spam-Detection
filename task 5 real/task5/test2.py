...
ax.scatter(positive['Total count'], positive['Spam words'], s=50, c='b', marker='o', label='Spam')  
ax.scatter(negative['Total count'], negative['Spam words'], s=50, c='r', marker='x', label='Not Spam')  
ax.legend()  
ax.set_xlabel('Total word count')  
ax.set_ylabel('Spam word count')
